...
export namespace PrivateREST {
    ...
    export type Response = Balance.Response | OpenOrders.Response | ClosedOrders.Response | GetWebSocketsToken.Response
    export type Result = Balance.Result | OpenOrders.Result | ClosedOrders.Result | GetWebSocketsToken.Result
